...
class UserBase(BaseSchema):
    ...
    full_name: str | None = Field(None, min_length=2, max_length=255, description="Full name")
...
class UserUpdate(BaseSchema):
    ...
    bin_iin: str | None = Field(None, min_length=6, max_length=20)
