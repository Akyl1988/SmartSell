...
def _outbox_enqueue_safe(
    ...
    *,
    ...
    event_type: str,
    payload: dict[str, Any] | None = None,
    channel: str | None = "erp",
    status: str = "pending",
    next_attempt_in_seconds: int | None = None,
    log_prefix: str = "InventoryOutbox",
) -> InventoryOutbox | None:
    try:
...
class ProductStock(BaseModel):
    ...
    def add_stock(self, qty: int, cost_price: Decimal | None = None):
    ...
    def _write_movement(
        ...
        *,
        ...
        commit: bool = False,
        erp_hook: bool = True,
        cost_price_for_avg: Decimal | None = None,
    ):
    ...
    def export_inventory_snapshot(
        ...
        *,
        ...
        warehouse_ids: Iterable[int] | None = None,
...
def low_stock_report(session: Session, *, warehouse_id: int | None = None) -> list[dict[str, Any]]:
...
def margin_report(
    ...
    *,
    date_from: datetime,
    date_to: datetime,
    price_fetcher: Callable[[int], Decimal] | None = None,
    warehouse_id: int | None = None,
    product_id: int | None = None,
) -> list[dict[str, Any]]:
    """
