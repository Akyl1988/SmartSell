...
def _mask_secret(value: str | None, keep_last: int = 4) -> str | None:
    if not value:
        return value
    v = value.strip()
    if len(v) <= keep_last:
...
class Company(Base):
    ...
    @property
    def subscription_days_left(self) -> int | None:
    ...
    # -----------------------------
    def soft_delete(self, *, by_user_id: int | None = None, reason: str | None = None) -> None:
    ...
    # Владение (owner)
    # -----------------------------
    def set_owner(self, new_owner_id: int | None) -> None:
    ...
    def masked_kaspi_api_key(self) -> str | None:
        return _mask_secret(self.kaspi_api_key)

    # -----------------------------
    # GDPR / Privacy
    # -----------------------------
    def register_gdpr_consent(self, *, version: str, ip: str | None = None) -> None:
    ...
    def set_settings(self, settings_json: str, *, by_user_id: int | None = None) -> None:
    ...
    def get_settings_dict(self, default: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    def set_settings_dict(self, data: dict[str, Any], *, by_user_id: int | None = None) -> None:
        prev = self.get_settings_dict()
    ...
    def patch_settings(self, *, by_user_id: int | None = None, **kwargs: Any) -> None:
    ...
    def restore_settings_version(self, version: int, *, by_user_id: int | None = None) -> None:
        """
    ...
    # -----------------------------
    def sync_mark_success(self, *, source: str, at: datetime | None = None) -> None:
    ...
    def sync_mark_error(self, *, source: str, code: str | None, message: str | None) -> None:
    ...
    async def orders_stats_async(
        ...
        *,
        ...
        include_status: Iterable[str] | None = None,
    ) -> dict[str, Any]:
        """
    ...
    async def bulk_archive_async(
        ...
        *,
        ...
        by_user_id: int | None = None,
        notify_fn: Callable[[int, str, dict[str, Any]], None] | None = None,
    ...
    # -----------------------------
    def _emit_audit_event(self, action: str, meta: dict[str, Any] | None = None) -> None:
