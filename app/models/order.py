...
class Order(Base):
    ...
    # helpers
    def confirm(self, user_id: int | None = None, note: str | None = None, *, session=None):
    ...
    def deliver(self, user_id: int | None = None, note: str | None = None, *, session=None):
        self.change_status(OrderStatus.DELIVERED, user_id, note, session=session)

    def complete(self, user_id: int | None = None, note: str | None = None, *, session=None):
        self.change_status(OrderStatus.COMPLETED, user_id, note, session=session)

    def cancel(self, user_id: int | None = None, note: str | None = None, *, session=None):
        self.change_status(OrderStatus.CANCELLED, user_id, note, session=session)

    def refund(self, user_id: int | None = None, note: str | None = None, *, session=None):
    ...
    async def revenue_time_series_async(
        ...
        *,
        ...
        only_status: OrderStatus | None = None,
    ...
    async def analytics_by_period_dataframe_async(
        ...
        *,
        ...
        date_from: datetime | None = None,
        date_to: datetime | None = None,
        status_filter: Sequence[OrderStatus] | None = None,
    ):
        """
    ...
    def export_query(
        *,
        ...
        status_in: Sequence[OrderStatus] | None = None,
        source_in: Sequence[OrderSource] | None = None,
        date_from: datetime | None = None,
        date_to: datetime | None = None,
