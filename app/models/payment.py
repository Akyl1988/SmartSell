...
class Payment(Base):
    ...
    def mark_processing(self, *, provider_payload: dict[str, Any] | None = None) -> None:
    ...
    def apply_refund(self, amount: Decimal, *, reason: str | None = None) -> Decimal:
        if amount is None:
    ...
    def export_query(
        *,
        status_in: Iterable[PaymentStatus] | None = None,
        provider_in: Iterable[PaymentProvider] | None = None,
    ...
    def _siem(self, event_name: str, *, extra: dict[str, Any] | None = None) -> None:
        payload = {
            "event": event_name,
            "payment_id": self.id,
...
class PaymentRefund(Base):
    ...
    def mark_completed(self, *, provider_payload: dict[str, Any] | None = None) -> None:
        if self.status not in {PaymentStatus.PENDING, PaymentStatus.PROCESSING}:
