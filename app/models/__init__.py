...
_LAZY_MODELS: dict[str, tuple[str, str]] = {
    ...
    "KaspiImportRun": ("app.models.kaspi_import_run", "KaspiImportRun"),
...
_DOMAIN_MODULES: tuple[str, ...] = (
    ...
    "app.models.subscription_override",
)
...
# Registry / discovery
# ------------------------------------------------------------------------------
def import_domain(module_name: str) -> Any | None:
...
# ------------------------------------------------------------------------------
def get_model_by_tablename(tablename: str) -> type[Any] | None:
...
# ------------------------------------------------------------------------------
def _module_mtime_of(cls: type[Any]) -> float | None:
...
# ------------------------------------------------------------------------------
def list_duplicate_tablenames(*, ignore: set[str] | None = None) -> list[str]:
    """
...
_INTROSPECTION_SNAPSHOT: _Snapshot | None = None
