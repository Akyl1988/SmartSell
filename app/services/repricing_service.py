...
class RepricingConfig:
    ...
    min_price: Decimal | None = None  # нижняя граница, нельзя ниже
    max_price: Decimal | None = None  # верхняя граница, нельзя выше
...
class RepricingService:
    ...
    def __init__(self, session: Session, kaspi: KaspiService | None = None):
    ...
    # ---------- Публичное API ----------
    def run_for_product_id(self, product_id: int) -> tuple[Decimal, str] | None:
    ...
    def run_bulk(self, product_ids: Iterable[int]) -> dict[int, tuple[Decimal, str] | None]:
        out: dict[int, tuple[Decimal, str] | None] = {}
    ...
    # ---------- Основная логика ----------
    def _reprice_product(self, product: Product) -> tuple[Decimal, str] | None:
    ...
    def _compute_new_price(
        current: Decimal,
        competitor: tuple[Decimal, str] | None,
        cfg: RepricingConfig,
    ...
    @staticmethod
    def _clamp(value: Decimal, floor: Decimal | None, ceil: Decimal | None) -> Decimal:
        v = Decimal(value)
