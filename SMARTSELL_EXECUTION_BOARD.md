...
| Release checklist and smoke gate | P0 | Partial | Founder/Ops | 1-2 days | SMARTSELL_RELEASE_CHECKLIST.md | Release checklist documented and used | No single enforced gate |