...
| Tenant diagnostics summary | P0 | Partial | Founder/Backend | 3-5 days |  | Tenant support surface shows sync/error/request/integration health | Data scattered |
| Billing state machine | P0 | Missing | Founder/Product+Backend | 2-3 days |  | Subscription states and transitions defined | Policy decisions pending |
...
| Incident process | P0 | Missing | Founder/Ops | 1-2 days |  | Severity rubric, owner rule, templates exist | No process |
