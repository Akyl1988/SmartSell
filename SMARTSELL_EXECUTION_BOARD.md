...
| Kaspi support visibility | P0 | Partial | Founder/Backend | 3-5 days | SMARTSELL_KASPI_SUPPORT_VISIBILITY.md | Last success/failure visible; errors understandable | Integration complexity |
