<#
Smoke: orders PDF report

Usage:
  pwsh -NoProfile -File .\scripts\smoke-reports-orders-pdf.ps1 -BaseUrl http://127.0.0.1:8000 -Limit 5
  pwsh -NoProfile -File .\scripts\smoke-reports-orders-pdf.ps1 -CompanyId 1001 -DateFrom 2026-02-01T00:00:00Z -DateTo 2026-02-15T23:59:59Z
...
$url = "$BaseUrl/api/v1/reports/orders.pdf"
if ($qs) { $url = "$($url)?$qs" }
