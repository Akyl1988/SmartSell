"""baseline (clean autogen)

Revision ID: 7b7794c032f7
Revises:
Create Date: 2025-10-29 09:47:05.465854+00:00
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_companies_kaspi_store_id"), "companies", ["kaspi_store_id"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_audit_logs_last_modified_by"), "audit_logs", ["last_modified_by"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_billing_payments_company_id"), "billing_payments", ["company_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_billing_payments_status"), "billing_payments", ["status"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_product_stocks_warehouse_id"), "product_stocks", ["warehouse_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_payment_refunds_external_id"), "payment_refunds", ["external_id"], unique=False
    )
    op.create_index(op.f("ix_payment_refunds_id"), "payment_refunds", ["id"], unique=False)
    op.create_index(
        op.f("ix_payment_refunds_payment_id"), "payment_refunds", ["payment_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_payment_refunds_refund_number"), "payment_refunds", ["refund_number"], unique=True
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_users_locked_by"), table_name="users")
    op.drop_index(op.f("ix_users_last_modified_by"), table_name="users")
